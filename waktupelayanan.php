                            ...
                            <div class="col-12">
                                <div class="card bg-dark text-dark bg-white" style="border-radius: 1rem;">
                                    <div class="card-body p-5">
                                        <h1 class="text-center mb-5">Waktu Pelayanan</h1>
                                        <div class="row">
                                            <div class="col"><img class="d-block mx-auto" src="img/jadwal.png"></div>
                                            <div class="col">
                                                <table class="m-auto h-100">
                                                    <tbody>
                                                        <tr>
                                                            <td><img src="img/clock.png" width="32px"></td>
                                                            <td class="ps-2">
                                                                <h4 class="fw-bold">SENIN - KAMIS</h4>
                                                                <span style="color: #777777;">07:00 - 14:00 WIB</span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td><img src="img/clock.png" width="32px"></td>
                                                            <td class="ps-2">
                                                                <h4 class="fw-bold">JUM'AT</h4>
                                                                <span style="color: #777777;">07:00 - 11:00 WIB</span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td><img src="img/clock.png" width="32px"></td>
                                                            <td class="ps-2">
                                                                <h4 class="fw-bold">MINGGU</h4>
                                                                <span style="color: #777777;">LIBUR</span>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
