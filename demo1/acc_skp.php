			...
			<div class="card">
				<div class="card-header">
					<div class="d-flex align-items-center">
						<h4 class="fw-bold text-uppercase">TAMPIL ACC REQUEST SURAT KETERANGAN PENGANTAR NIKAH</h4>
					</div>
				</div>
				<div class="card-body">
					<form method="POST">
									...
									?>
										<tr>
											...
											<td>
												...
												<input type="submit" name="acc" class="btn btn-primary btn-sm" value="ACC" style="background: #1a2035 !important;">
