									...
									?>
										<tr>
											...
											<td>
												...
												<input type="checkbox" name="check[$i]" style="background-color: #1a2035 !important;" value="<?php echo $id_request_sktm; ?>">
												<input type="submit" name="acc" class="btn btn-primary btn-sm" style="background: #1a2035 !important;" value="ACC">
