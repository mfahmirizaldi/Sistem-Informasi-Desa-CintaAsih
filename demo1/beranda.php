		...
		<div class="row mt--2">
			...
			<div class="col-md-3 pr-md-0">
				<div class="card-pricing2 card-success">
					<div class="pricing-header">
						<h6 class="fw-bold text-center text-uppercase">Surat Keterangan Usaha</h6><br>
					</div>
					<div class="price-value">
						<div class="value">
							<span class="currency"></span>
			...
			<div class="col-md-3 pr-md-0">
				<div class="card-pricing2 card-warning">
					<div class="pricing-header">
						<h6 class="fw-bold text-center text-uppercase">Surat Keterangan Pengantar Nikah</h6>
					</div>
					<div class="price-value">
						<div class="value">
							<span class="currency"></span>
