...
CREATE TABLE `data_request_skp` (
  ...
  `keperluan` varchar(20) NOT NULL DEFAULT,
  `keterangan` varchar(50) NOT NULL DEFAULT 'Data sedang diperiksa oleh Staf',
  `request` varchar(20) NOT NULL DEFAULT 'PENGATAR MENIKAH',
  `status` int(11) NOT NULL DEFAULT '0',
  `acc` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `data_request_skp` (`id_request_skp`, `nik`, `tanggal_request`,`keperluan`, `scan_ktp`, `scan_kk`, `keterangan`,  `request`, `status`, `acc`) VALUES
